...
const APIKEY = "ae5c0f83cbf97b69edae241fa13475a0";
    ...
    <WeatherContainer>
      <CurrentContainer>
        ...
        <CurrentTempContainer>
          <Fontisto name={icons[forecasts.current.weather[0].main]} size={68} />
          <View>
          ...
          <SlideContainer key={data.dt}>
            ...
            <SlideClothContainer>
              <SlideClothColumn>
                <Text>상의</Text>
                <Cloth />
                <Fontisto name="like" size={25} style={{ color: "skyblue" }} />
              </SlideClothColumn>
              <ClothSeparator />
              <SlideClothColumn>
                <Text>하의</Text>
